...
Canonical Python artifact package for the Tigr ASGI contract. Generated from the canonical `contract/` directory in this repository.

Python consumers get direct filesystem access to vendored YAML, JSON Schema, manifest, and checksum artifacts.
